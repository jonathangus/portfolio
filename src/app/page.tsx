...
export default function Home() {
  return (
    <main>
      <div className="flex flex-col md:flex-row p-6 pb-0  md:mt-[230px] md:px-12 mx-auto md:justify-center">
          ...
          <div className="mx-0 md:mx-auto">
            <section className="mb-24">
              ...
              <div className=" text-lg text-muted-foreground">
                ...
                <p>
                  I bring an entrepreneurial approach, leadership background,
                  and product-focused mindset to every project, continually
                  looking for ways to build great user experiences and work with
                  high agency.
                </p>
              </div>
            </section>
